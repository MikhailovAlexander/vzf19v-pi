...
namespace ClassWork0712
{
    class Program
    {
        ...
        static void GetRandomArray()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                while(list.Contains(currentNumber))
                    currentNumber = rnd.Next(-100, 100);
                list.Add(currentNumber);
                array[i] = currentNumber;
                Console.Write($"[{currentNumber,3}] ");
            }
            Console.WriteLine();
        }
        ...
        static void SoccerTable()
        {
            ...
            Console.WriteLine($"\nКоличество выигрышей команды: {winCount}" +
                ...
                $"\nКоличество игр с разностью забитых и пропущеных мячей >= 3: {diffCount}" +
        ...
        static void SignChangeCount()
        {
            ...
            Console.WriteLine("Целочисленный массив со случайными элементами:");
